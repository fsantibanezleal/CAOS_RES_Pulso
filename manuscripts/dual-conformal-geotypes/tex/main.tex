...
\author{%
  ...
  \thanks{Preprint, 2026, version 2 (comprehensive). Code, committed derived artifacts, and the
...
finding that fracture intensity ($\log I$) is the top attributed control. We then extend the
...
out-of-catalogue flag (empirical coverage $0.85$--$0.94$ at target across the rich-method cases).
Second, and the methodological contribution, we introduce a \emph{dual-representation Mondrian
conformal} assigner that conformalizes jointly across two nonconformity scores, the DTW shape
...
families, and across the labelled cases fracture intensity ($\log I$) is the top attributed
control (largest mean absolute SHAP), partially reproducing the paper's fracture-intensity finding.
...
the rich-method cases the empirical marginal coverage is $0.85$--$0.94$ at the target level, with an
...
match with implausible physics is excluded. This is beyond single-score conformal and beyond
random-forest/SHAP attribution, which has no coverage control: a coverage-controlled assignment that
fuses shape space and physics-descriptor space.
...
$0.85\!\to\!0.87$ dual; REAL\_B $0.86$; REAL\_C $0.58$; BENCH\_A $0.57$ / $0.85\!\to\!0.73$;
BENCH\_B $0.48$ / $0.87\!\to\!0.75$; BENCH\_C $0.62$ / $0.86\!\to\!0.80$; DFM01 $0.62$; DFM03 $0.65$;
FIELD\_horkheim $0.63$; FIELD\_lauswiesen $0.42$; WR01 $0.15$ / $0.80\!\to\!0.73$; the analytic WR
...
\bibitem{data4tu} E.~Kamel Targhi \emph{et al.}, ``GeoDFN networks and pressure transients for
geologically consistent fluid flow analysis (dataset),'' 4TU.ResearchData, 2026,
