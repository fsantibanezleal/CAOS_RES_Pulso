...
export const ARCH_TABS: ArchTab[] = [
  ...
  },
  {
    ...
    body_es:
      'El nucleo cientifico es una escalera profunda de metodos, de clasico a SOTA. Diagnosticos: derivada de Bourdet + deteccion de regimenes de flujo, ajustes Warren-Root y Theis, deconvolucion. Distancias y agrupamiento: DTW + PAM (FasterPAM), baricentros soft-DTW, k-Shape, jerarquico, espectral, HDBSCAN. Representaciones: MDS clasico, UMAP, t-SNE, PCA funcional, features catch22. Aprendidos (GPU a ONNX): un clasificador InceptionTime, un autoencoder convolucional para puntuar fuera de distribucion, un encoder contrastivo para recuperacion, un transformer de parches. Atribucion: Random Forest + SHAP con un gate de exactitud. Asignacion: prediccion split-conforme (y una variante condicional por clase).',
